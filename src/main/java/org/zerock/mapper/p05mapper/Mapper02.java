...
public interface Mapper02 {
	...
	public List<String> getProductNameByCategory(String category);
	
	public List<String> getProductNameByCategoryAndPrice(@Param("category") String category, @Param("price") Double price);
